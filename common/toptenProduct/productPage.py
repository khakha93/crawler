...
from toptenProduct.productInfo import ProductInfo
from toptenProduct.productImage import ProductImage
from toptenProduct.productSize import ProductSize
...
class ProductPage(ProductInfo, ProductImage, ProductSize, Pp):
    ...
    #     # 이미지 저장
    #     try:
    #         if self.save_image(product_id) == -1:
    #             self.fill_err_product('image_error', self.url, product_id=product_id, etc='HTTP Error 404: Not Found')
    #     except Exception as ex:
